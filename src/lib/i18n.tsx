...
const copy = {
  en: {
    ...
    yourName: 'Your name',
    yourNameHelp: 'This is the name others in your household see.',
    yourNameSaved: 'Your name is saved.',
    updateNameError: 'Your name could not be saved. Please try again.',
    people: 'People',
    you: 'You',
    owner: 'Owner',
    member: 'Member',
    ...
    dishSuggestionsCopy: 'Get a few new ideas based on your saved dishes and recent dinners.',
  ...
  da: {
    ...
    yourName: 'Dit navn',
    yourNameHelp: 'Det er det navn, andre i din husstand ser.',
    yourNameSaved: 'Dit navn er gemt.',
    updateNameError: 'Dit navn kunne ikke gemmes. Prøv igen.',
    people: 'Personer',
    you: 'Dig',
    owner: 'Ejer',
    member: 'Medlem',
    ...
    getSuggestions: 'Få forslag',
    dishSuggestionsCopy: 'Få nye idéer ud fra jeres gemte retter og seneste aftensmad.',
    ...
    add: 'Tilføj',
    savedDish: 'Gemt',
    suggestedPlan: 'Foreslået madplan',
    useThisPlan: 'Brug denne plan',
    savingPlan: 'Gemmer planen…',
    planApplied: 'Madplanen er gemt.',
