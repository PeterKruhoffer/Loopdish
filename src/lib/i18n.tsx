...
const copy = {
  en: {
    ...
    poweredByCloudflare: 'Powered by Cloudflare',
    suggestionsIntro:
      'Get ideas from your saved dishes and recent dinner history. Nothing is added until you choose it.',
    suggestNewDishes: 'Find new dishes',
    suggestNewDishesCopy:
      'Up to five dinners that fit your rotation without repeating what is already saved.',
    planNextWeek: 'Plan next week',
    planNextWeekCopy: 'A seven-night draft using familiar dishes with a couple of new ideas.',
    thinking: 'Thinking…',
    ...
    add: 'Add',
    savedDish: 'Saved',
    nextWeeksPlan: "Next week's plan",
    useThisPlan: 'Use this plan',
    savingPlan: 'Saving plan…',
    planApplied: "Next week's plan is saved.",
    planAppliedWithCompleted: 'The plan is saved. Completed dinners were left unchanged.',
    planDisclosure:
      'Confirming replaces dinners already planned for these dates. Completed dinners stay unchanged.',
  ...
  da: {
    ...
    poweredByCloudflare: 'Drevet af Cloudflare',
    suggestionsIntro:
      'Få idéer ud fra jeres gemte retter og seneste madhistorik. Intet tilføjes, før I vælger det.',
    suggestNewDishes: 'Find nye retter',
    suggestNewDishesCopy:
      'Op til fem retter, der passer til jeres vaner uden at gentage dem, I har gemt.',
    planNextWeek: 'Planlæg næste uge',
    planNextWeekCopy: 'Et udkast til syv aftener med velkendte retter og et par nye idéer.',
    thinking: 'Tænker…',
    ...
    add: 'Tilføj',
    savedDish: 'Gemt',
    nextWeeksPlan: 'Næste uges madplan',
    useThisPlan: 'Brug denne plan',
    savingPlan: 'Gemmer planen…',
    planApplied: 'Næste uges madplan er gemt.',
    planAppliedWithCompleted: 'Madplanen er gemt. Afsluttede måltider blev ikke ændret.',
    planDisclosure:
      'Når I bekræfter, erstattes planlagte retter på disse datoer. Afsluttede måltider ændres ikke.',
